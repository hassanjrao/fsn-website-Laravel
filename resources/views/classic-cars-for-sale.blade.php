        ...
        <div class="row">
            ...
            <div class="col-lg-12 mb-5">
                ...
                <div class="services-links">
                    ...
                    <h3 class="text-center mb-4">Classic Cars For Sale Services in</h3>
                    ...
                    <div class="row servc-links">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6">
                            ...
                            <ul>
                                ...
                                ?>
                                <li><a href="{{ route("classic-cars-for-sale-city","$ct")}}"><?php echo ucwords($city) ?></a>
                                </li>
