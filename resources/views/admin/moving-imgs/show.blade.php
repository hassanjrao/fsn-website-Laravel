                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <form action="{{route("admin.moving.update","$moving_img->id")}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="caption" class="form-control" placeholder="Caption"
                                                required="" value="{{$moving_img->caption}}" />
                                        </div>

                                        <div class="form-group">
                                            <input type="file" name="image" class="form-control" placeholder="Password"
                                                required="" />
                                            <img src="/storage/images/moving-imgs/{{$moving_img->image}}" width="60px" height="60px">
                                        </div>
